...
// Images
gulp.task('img_exec', function() {
  return gulp.src('_img/exec/*.{png,jpg}')
    .pipe($.responsive({
      // For all the images in the folder
      '*': [{
        width: 230,
    ...
    .pipe(imagemin())
    .pipe(gulp.dest('assets/img/exec/'));
});

// Images
gulp.task('img_slider', function() {
  return gulp.src('_img/slider/*.{png,jpg}')
    .pipe($.responsive({
      // For all the images in the folder
      '*': [{
        width: 230,
    ...
    .pipe(imagemin())
    .pipe(gulp.dest('assets/img/slider/'));
});
