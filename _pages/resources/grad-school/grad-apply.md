...
Your resume should be either exactly 1 or 2 pages. It might look weird to make it 1.5 pages or something like that (use your own judgement). There is generally a 2 page limit that prevents it from being too long. To make formatting easier, you should use LaTeX to write up your CV. Word is fine, but using LaTeX produces a more professional looking document. You can use a [template](https://www.sharelatex.com/templates/cv-or-resume) to make it easier. [This one](https://www.sharelatex.com/templates/cv-or-resume/professional-cv) is pretty good.
